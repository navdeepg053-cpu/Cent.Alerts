...
curl -X GET "https://your-app.com/api/availability"

# Test notifications history
curl -X GET "https://your-app.com/api/notifications/history" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
db.availability_snapshots.find().limit(2).pretty();
"
...
✅ Alert toggles work correctly
✅ Availability data displays
